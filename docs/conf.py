...
htmlhelp_basename = 'nx_altairdoc'
...
latex_documents = [
    (master_doc, 'nx_altair.tex', 'nx\\_altair Documentation',
...
man_pages = [
    (master_doc, 'nx_altair', 'nx_altair Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nx_altair', 'nx_altair Documentation',
     author, 'nx_altair', 'One line description of project.',
     'Miscellaneous'),
]
